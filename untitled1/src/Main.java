                        ...
                        switch (ch) {
                                ...
                                try {
                                    for (Transportation e : transportationHashMap.values()) {
                                        if (id == e.getTransportation_id()) {
                                            transportationHashMap.remove(id);
                                           Company.display_transportation(transportationHashMap);
                                            k1++;
                                        }
                                    }
                            ...
                            case 10:
                                ...
                                name = scan.next();
                                    ...
                                    branchHashMap.put(ka, new Branch(ka, name));
                                ka++;
                        ...
                        switch (ff) {
                            case 1:
                                ...
                                for (int i = 0; i < transportationHashMap.size(); i++) {
                                    if (id == transportationHashMap.get(i).getTransportation_id()) {
                                        System.out.println("Succesfully has been entered the system ");
